...
////  循环队列的数组实现，队尾指针指向队尾的下一个元素,且浪费一个存储空间，没有length的辅助变量。
//
//#include <cstdio>
//
...
// * 判满
// * 循环队列判满方式：
// * 1、浪费一个存储空间：(Q->rear +1)%MAXSIZE == Q->front
// * @param Q
// * @return
// */
...
//    }
//    Q->data[Q->rear] = e;
//    Q->rear = (Q->rear + 1)%MAXSIZE; // 循环队列队尾指向下个元素，循环队列必须这么写
//}
//
//void OutQueue(PSeqQueue Q,ElemType &e){
//    if(Q==NULL)
...
//    if(Q==NULL)
//        return true;
//    if((Q->rear +1)%MAXSIZE == Q->front)  // 判满条件，谨记
//        return true;
//    return false;
//}
//
